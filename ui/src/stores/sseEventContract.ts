...
export const SERVER_SSE_EVENT_DECISIONS = {
  "activity.logged": {
    kind: "ignore",
    reason: "activity feeds are refetched by their views",
  },
  ...
  "note.created": {
    kind: "ignore",
    reason: "memory views load notes through MCP queries",
  },
  "note.updated": {
    kind: "ignore",
    reason: "memory views load notes through MCP queries",
  ...
  "note.contradiction_candidates": {
    kind: "ignore",
    reason:
      "contradiction follow-up is handled by the memory control-plane worker",
  },
  "note.missing_summary": {
    kind: "ignore",
  ...
  "oauth.device_code": {
    kind: "ignore",
    reason: "device-code responses are consumed by the initiating flow",
  },
  ...
  "session_message.inserted": {
    kind: "ignore",
    reason:
      "legacy chat-message repository event; live task session messages use session.message",
  },
  "session.token_update": {
    kind: "ignore",
    reason: "token counters are loaded through session detail queries",
  },
...
export function isServerSSEEventName(
  rawName: string,
): rawName is ServerSSEEventName {
