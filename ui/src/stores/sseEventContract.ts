...
export const SERVER_SSE_EVENT_NAMES = [
  ...
  "proposal_feedback.withdrawn",
  "proposal_feedback_refinement.disposition_updated",
  "proposal_feedback_refinement.disposition_rejected",
  "session.dispatched",
  "session.started",
  "session.completed",
  "session.interrupted",
...
export const SERVER_SSE_EVENT_DECISIONS = {
  ...
  "proposal_feedback.withdrawn": { kind: "dispatch", eventType: "proposal_feedback_withdrawn" },
  "proposal_feedback_refinement.disposition_updated": {
    kind: "dispatch",
