              ...
              <CardContent className="relative z-10 flex-1 overflow-y-auto px-3 pt-4">
                ...
                <div className="flex flex-col gap-3.5">
                  {epicGroups.map(([epicKey, epicTasks]) => {
                    ...
                    return (
                      <Card key={epicKey} size="sm" className="gap-0 cursor-pointer bg-[#1a1a2e] py-3 ring-white/[0.04] transition-colors hover:bg-[#1f1f35]" onClick={() => toggleEpic(column.key, epicKey)}>
                        <CardContent>
