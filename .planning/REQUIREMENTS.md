...
- [ ] **SKAF-02**: Directory structure matches Claude Code plugin format (skills/djinn-planning/)
- [ ] **SKAF-03**: Each workflow declares a tool subset (5-10 MCP tools, not 70+) to prevent context explosion
- [ ] **SKAF-04**: Progressive disclosure pattern — metadata → instructions → references/cookbooks
