...
case 'render-digest': x.deployment.render_digest.commit=m; break;
case 'node-digest': x.deployment.node_digest.commit=m; break;
case 'workload-digest': x.deployment.workload_digest.commit=m; break;
