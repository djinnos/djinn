...
After fixing any bug involving:
- Invalid data reaching dangerous operations
- Configuration/environment propagation failures
- Test pollution or isolation failures
