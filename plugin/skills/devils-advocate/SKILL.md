...
| Excuse | Reality |
|--------|---------|
| "We don't have time to stress-test" | Finding flaws now is faster than fixing them in production |
| "Team already agrees it's good" | Unanimous agreement is a red flag, not a green light |
| "Don't want to be negative" | Devil's advocate is care, not criticism |
| "It's obviously going to work" | Obvious confidence hides blind spots |
| "We'll fix issues as they come up" | Reactive fixing costs 10x more than proactive finding |
| "The expert said it's fine" | Experts have blind spots too. Challenge respectfully. |
