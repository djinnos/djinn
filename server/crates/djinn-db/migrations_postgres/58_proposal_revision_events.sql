...
ALTER TABLE proposal_revisions
    ...
    ADD COLUMN status_from VARCHAR(32) NULL,
    ADD COLUMN status_to VARCHAR(32) NULL,
...
ALTER TABLE proposal_revisions DROP CONSTRAINT proposal_revisions_proposal_id_seq_key;

CREATE UNIQUE INDEX proposal_revisions_spec_seq_unique
    ON proposal_revisions(proposal_id, seq)
    WHERE event_kind = 'spec_revision';

CREATE INDEX proposal_revisions_proposal_created_at
