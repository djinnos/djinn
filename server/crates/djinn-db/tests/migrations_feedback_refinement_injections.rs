//! Contract coverage for migration 175's dormant feedback-refinement storage.
use sqlx::Connection;
use sqlx::postgres::PgPoolOptions;

#[tokio::test]
async fn migration_175_preserves_legacy_feedback_and_enforces_generation_contract() {
