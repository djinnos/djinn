...
pub use repositories::{
    ...
    note::{
        ...
        NoteSearchParams, NoteVectorStore, ProposedBackfillAnchor, QdrantConfig,
        QdrantNoteVectorStore, STALE_CITATION, UpsertNoteEmbedding, build_lexical_search_plan,
