...
pub use repositories::{
    ...
    note::{
        ...
        CreatedCanonicalConsolidatedNote, DbNoteGroup, EmbeddedNote, NoopNoteVectorStore,
        NoteAssociationEntry, NoteConsolidationRepository, NoteDedupCandidate, NoteEmbeddingMatch,
        NoteEmbeddingProvider, NoteEmbeddingRecord, NoteRepository, NoteSearchParams,
        NoteVectorBackend, NoteVectorStore, QdrantNoteVectorStore, STALE_CITATION,
        SqliteVecNoteVectorStore, UpdateNoteIndexParams, UpsertNoteEmbedding, file_path_for,
