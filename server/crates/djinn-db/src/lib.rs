...
pub mod test_support {
    pub use crate::repositories::test_support::{
        ...
        NoteRevisionContractRow, UsageTestSessionSeed, UsageTestTaskSeed, add_blocker_edge,
        ...
        ensure_doctor_findings_schema, event_bus_for, make_project, note_and_revision_counts,
        note_revision_contract_rows, nullify_note_confidence_for_test,
