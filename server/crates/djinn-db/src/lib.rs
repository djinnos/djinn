...
pub use repositories::{
    ...
    note::{
        ...
        NoteRevisionEventInput, NoteRevisionEventKind, NoteRevisionEventRow, NoteRevisionReason,
        NoteRevisionSnapshot, NoteRevisionValidationError, NoteSearchParams, NoteStatus,
