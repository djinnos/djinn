...
pub mod test_support {
    ...
    pub use crate::repositories::test_support::{
        ...
        TypedEvidenceDispositionSnapshotForTest, TypedEvidenceRetryAuthorityForTest,
        TypedEvidenceRetryFixtureForTest, TypedEvidenceRetryScenarioForTest,
        TypedEvidenceRetrySnapshotForTest, UsageTestSessionSeed, UsageTestTaskSeed,
        activate_direct_delivery_epoch_for_test, activity_row_count_for_test, add_blocker_edge,
        ...
        ci_route_plant_reserved_for_test, ci_route_row_count_for_test,
        close_evidence_dispatch_task_for_test, close_task_at,
        ...
        delete_session_row, direct_delivery_matrix_counts_for_test, drop_table_cascade_for_test,
        ...
        model_turn_request_lifecycle_fixture,
        ...
        persist_project_github_installation_for_test, proposal_lint_revision_id_for_test,
        queue_feedback_refinement_generation_for_test, refinement_run_audit_for_test,
        refinement_run_read_only_snapshot_for_test, reject_atomic_demand_debate_inserts_for_test,
        reject_ci_route_attempt_updates_for_test, reject_evidence_findings_debates_for_test,
        reject_evidence_projection_inserts_for_test, reject_interrupted_session_for_test,
        reject_new_task_arbitrations_for_test, reject_refinement_successor_for_test,
        reject_refinement_terminal_audit_for_test, reject_task_liveness_evidence_for_test,
        remove_direct_delivery_epoch_for_test, rename_note_confidence_column_for_test,
...
pub use repositories::{
    ...
    model_turn_admission::{
        ...
        ModelTurnDecisionDiagnostic, ModelTurnDecisionKind, ModelTurnDecisionRecordInput,
    ...
    typed_evidence::{
        ...
        TypedEvidenceDemandDispatchErrorInput, TypedEvidenceDispositionProjection,
        TypedEvidenceFindingProjection, TypedEvidenceLifecycleProjection, TypedEvidenceRepository,
