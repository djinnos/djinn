...
pub mod test_support {
    ...
    pub use crate::repositories::test_support::{
        AtomicEvidenceDemandCountsForTest, DirectDeliveryMatrixCountsForTest,
        ...
        TypedEvidenceDispositionSnapshotForTest, TypedEvidenceIngressFixtureForTest,
        ...
        UsageTestTaskSeed, activate_direct_delivery_epoch_for_test, activity_row_count_for_test,
        ...
        dispose_typed_evidence_validation_for_test, drop_table_cascade_for_test,
        drop_table_for_test, elapse_refinement_run_wall_clock_for_test,
        ensure_doctor_findings_schema, equalize_note_temporal_signals_for_test, event_bus_for,
        ...
        seed_board_health_mismatch_candidate, seed_breaker_open_dispatch_state,
        seed_chat_session_row, seed_direct_delivery_proposal_owner_for_test,
        seed_legacy_launcher_authority_for_test, seed_model_turn_admission_fixture, seed_project,
        seed_rate_limited_dispatch_state, seed_readiness_detail_projection_for_test,
        seed_session_row, seed_session_row_with_id, seed_stale_typed_evidence_disposition_for_test,
        seed_task_row, seed_typed_evidence_ingress_fixture_for_test,
        seed_unknown_direct_delivery_epoch_for_test, seed_workspace_coverage_for_test,
        set_model_turn_capability_fixture, set_model_turn_phase_fixture,
...
pub use repositories::{
    ...
    model_turn_admission::{
        ...
        ModelTurnControllerWindow, ModelTurnDecisionDiagnostic, ModelTurnDecisionKind,
        ModelTurnDecisionRecordInput, ModelTurnIdentityState, ModelTurnLease,
