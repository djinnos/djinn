...
pub use repositories::{
    ...
    note::{
        ...
        NoteEmbeddingProvider, NoteEmbeddingRecord, NoteRepairEmbeddingRow, NoteRepository,
        NoteSearchParams, NoteVectorStore, PromptBudgetReport, ProposedBackfillAnchor,
        QdrantConfig, QdrantNoteVectorStore, QueryReplayReport, RankingReport, ReplayCriteria,
        ReplayFixture, ReplayNote, ReplayQuery, ReplayReport, STALE_CITATION, UpsertNoteEmbedding,
        anchor_embedding_replay_fixture, build_lexical_search_plan, embedding_content_hash,
        ...
        legacy_embedding_document_text, lexical_search_threshold, normalize_lexical_score,
        ...
        render_anchor_embedding_replay_report_markdown, render_note_markdown, rrf_fuse,
        sanitize_postgres_tsquery, sanitize_sqlite_fts5_query, slugify, task_branch_name,
