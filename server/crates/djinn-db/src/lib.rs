...
pub mod test_support {
    ...
    pub use crate::repositories::test_support::{
        ...
        ci_route_row_count_for_test, close_task_at,
...
pub use repositories::{
    ...
    proposal::{
        ...
        ProposalListQuery, ProposalListResult, ProposalListSummaryRow, ProposalMemoryRef,
        ProposalRef, ProposalRepository, ProposalUpdateInput,
    },
    proposal_integrity::{
