...
pub use repositories::{
    ...
    note::{
        ...
        NoteEmbeddingRecord, NoteRepairEmbeddingRow, NoteRepository, NoteSearchParams,
        NoteVectorStore, QdrantConfig, QdrantNoteVectorStore, STALE_CITATION, UpsertNoteEmbedding,
        build_lexical_search_plan, embedding_content_hash, embedding_document_text,
        ...
        render_note_markdown, rrf_fuse, sanitize_postgres_tsquery, sanitize_sqlite_fts5_query,
        slugify, task_branch_name, title_from_permalink, validate_postgres_tsvector_threshold,
