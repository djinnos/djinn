...
pub use repositories::{
    ...
    note::{
        ...
        NoteRevisionValidationError, NoteSearchParams, NoteStatus, NoteVectorStore,
        PromptBudgetReport, ProposedBackfillAnchor, QdrantConfig, QdrantNoteVectorStore,
        QueryReplayReport, RankingReport, ReplayCriteria, ReplayFixture, ReplayNote, ReplayQuery,
        ReplayReport, STALE_CITATION, STALE_DECAY_SIGNAL, TrustedNoteRevisionAttribution,
