...
pub mod test_support {
    ...
    pub use crate::repositories::test_support::{
        ...
        TypedEvidenceRetrySnapshotForTest, TypedEvidenceRolloutSnapshotForTest,
        ...
        backdate_task_run_started_at, backdate_task_updated_at,
        ...
        direct_delivery_generations_for_test, direct_delivery_generations_if_readable_for_test,
        direct_delivery_lease_rows_for_test, direct_delivery_matrix_counts_for_test,
        ...
        evidence_dispatch_recovery_snapshot_for_test,
        evidence_plan_invocation_availability_for_test, expire_coordinator_incarnation_for_test,
        expire_direct_delivery_lease_for_test, force_refinement_run_park_kind_for_test,
        ...
        model_turn_launch_identities_fixture, model_turn_lease_count_for_pool_fixture,
        model_turn_lease_heartbeat_snapshot_fixture, model_turn_lease_lifecycle_fixture,
        model_turn_lease_owner_pod_uid_fixture, model_turn_lease_total_count_fixture,
        model_turn_max_pool_id_fixture, model_turn_request_lifecycle_fixture,
        model_turn_terminal_fixture, nullify_note_confidence_for_test,
        override_debate_trail_body_metadata, overwrite_legacy_evidence_authority_for_test,
        pending_feedback_disposition_counts_for_test, persist_project_github_installation_for_test,
        proposal_build_attempt_ids_for_test, proposal_lint_revision_id_for_test,
        queue_feedback_refinement_generation_for_test, refinement_outcome_attempts_for_test,
        ...
        remove_task_delivery_rows_for_test, rename_note_confidence_column_for_test,
        replace_legacy_proposal_head_for_test, restore_active_direct_delivery_epoch_for_test,
        revoke_direct_delivery_capability_for_test, seed_board_health_mismatch_candidate,
        ...
        set_model_turn_phase_fixture, set_model_turn_schema_marker_present_for_test,
        ...
        table_digest_for_test, task_attempt_count_for_test, task_row_count_for_test,
        task_status_for_test, typed_evidence_disposition_count_for_finding_for_test,
        ...
        typed_evidence_validation_snapshot_for_test, write_legacy_only_evidence_authority_for_test,
    };
}
...
pub use repositories::{
    ...
    direct_delivery_activation::{
        AcquireDeliveryLeaseInput, AcquireDeliveryLeaseResult, ActivateDirectDeliveryEpochInput,
        ActivateDirectDeliveryEpochResult, CapabilityCensusGap, DirectDeliveryActivationRefusal,
        DirectDeliveryActivationRepository,
    },
    ...
    model_turn_admission::{
        MODEL_TURN_ADMISSION_SCHEMA_VERSION, MODEL_TURN_LEARNED_CONCURRENCY_MAX,
        MODEL_TURN_PHASE_PREDICATE_FRESHNESS_SECONDS, ModelTurnAcquireInput,
        ModelTurnAcquireOutcome, ModelTurnAcquireTurnInput, ModelTurnAdmissionPhase,
        ModelTurnAdmissionRejection, ModelTurnAdmissionRepository,
        ModelTurnAdmissionSchemaReadiness, ModelTurnAdmissionWait, ModelTurnAuthoritativeUsage,
        ModelTurnBucketBinding, ModelTurnBucketDebit, ModelTurnBucketKind,
        ModelTurnCapabilityHeartbeatInput, ModelTurnCapabilityState, ModelTurnCompatibilityPhase,
        ...
        ModelTurnDecisionRecordInput, ModelTurnEnforcementOutcome, ModelTurnEnforcementPassInput,
        ModelTurnExpectedPathKey, ModelTurnIdentityState, ModelTurnLearnedConcurrencyInput,
        ModelTurnLearnerWindow, ModelTurnLease, ModelTurnLeaseExpiryInput, ModelTurnLeaseIdentity,
        ModelTurnLeaseLifecycle, ModelTurnLeaseMutationOutcome, ModelTurnLeaseReconciliationInput,
        ModelTurnLeaseTerminalOutcome, ModelTurnModeChangeInput, ModelTurnModeChangeOutcome,
        ModelTurnModeChangeReason, ModelTurnModeChangeRejection, ModelTurnObservation,
        ModelTurnPhaseCEvidence, ModelTurnPhaseCEvidenceInput, ModelTurnPhaseCEvidenceOutcome,
        ModelTurnPhaseCEvidenceStage, ModelTurnPhasePredicate, ModelTurnPhasePredicateResults,
        ModelTurnPhaseTransitionOutcome, ModelTurnPhaseTransitionRequest, ModelTurnPool,
        ModelTurnReservation, ModelTurnReservationBucket, ModelTurnReservationState,
    ...
    task::{
        ...
        DispositionScope, EffectiveCreatorProvenance, LEGACY_DELIVERY_LABEL, ListQuery, ListResult,
        ReadyQuery, TaskIntegrationResult, TaskIntegrationStaleness, UpdateTaskParams,
    ...
    typed_evidence::{
        ...
        TypedEvidenceParityProbe, TypedEvidencePresentation, TypedEvidenceRecordedDisposition,
        TypedEvidenceRepository, TypedEvidenceRetryDispatchErrorInput,
