...
pub use repositories::{
    ...
    note::{
        ...
        NoteAssociationEntry, NoteConsolidationRepository, NoteDedupCandidate,
        NoteEmbeddingMatch, NoteEmbeddingProvider, NoteEmbeddingRecord,
        NoteRepairEmbeddingRow, NoteRepository, NoteSearchParams, NoteVectorStore,
        ProposedBackfillAnchor, QdrantConfig, QdrantNoteVectorStore, STALE_CITATION,
        UpsertNoteEmbedding, build_lexical_search_plan, embedding_content_hash,
        embedding_document_text, executable_lexical_search_sql, folder_for_type,
        folder_for_type_with_status, infer_embedding_branch_from_worktree, infer_note_type,
        is_singleton, lexical_search_threshold, normalize_lexical_score,
        normalize_virtual_note_path, permalink_for, permalink_for_with_status,
        permalink_from_virtual_note_path, propose_anchor_deterministic, render_note_markdown,
        rrf_fuse, sanitize_postgres_tsquery, sanitize_sqlite_fts5_query, slugify,
        task_branch_name, title_from_permalink, validate_postgres_tsvector_threshold,
