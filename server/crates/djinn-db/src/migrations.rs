...
pub const CREATOR_CONTRACT_MIGRATION_VERSION: i64 = 138;
...
pub async fn run_postgres_migrations_on_connection(
    ...
    // migration 138, and its caller may then retry on this same connection.
    ...
    // Whitespace-only input is deliberately stored as empty so migration 138's
