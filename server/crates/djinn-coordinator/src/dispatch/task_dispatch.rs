...
use crate::roles_compat::DispatchContext;
...
mod inflight_ledger_tests {
    ...
    fn wnd1_actor_for_tests(
        ...
        CoordinatorActor {
            ...
            role_registry: std::sync::Arc::new(crate::roles_compat::RoleRegistry::new()),
    ...
    async fn wnd1_ready_queue_fixture_is_visible_to_dispatch_selection_and_reads_caps() {
        ...
        assert!(fixture_ready.iter().all(|task| {
            task.status == "open"
                ...
                && crate::roles_compat::RoleRegistry::new()
                    .role_for_task(task, &crate::roles_compat::DispatchContext)
                    == Some("worker")
        }));
