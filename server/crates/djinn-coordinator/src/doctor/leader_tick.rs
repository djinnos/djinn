...
mod tests {
    ...
    async fn malformed_group_preservation_is_selective_and_recovers_on_healthy_refresh() {
        ...
        // mixed snapshot will update and resolve. The other malformed alarm
        // key is deliberately absent before reconciliation.
        ...
        // Healthy siblings are unaffected by another group's malformed state:
        // one is updated, one resolves by healthy absence, and one is created.
        ...
        // Once every group is healthy, normal absence reconciliation resumes
        // for the formerly malformed identity as well as every healthy row.
