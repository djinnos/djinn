...
pub const DEFAULT_NUDGE_HINT: &str =
...
pub fn resolve_corrective_nudge_hint(evidence: &NudgeHintEvidence) -> String {
...
#[allow(dead_code)]
pub fn live_mover_reasons(evidence: &LiveMoverEvidence) -> Vec<LiveMoverReason> {
...
#[allow(dead_code)]
pub fn has_live_mover(evidence: &LiveMoverEvidence) -> bool {
...
#[allow(dead_code)]
pub fn live_mover_summary(evidence: &LiveMoverEvidence) -> LiveMoverSummary {
...
#[allow(dead_code)]
pub fn summarize_live_mover(evidence: &LiveMoverEvidence) -> LiveMoverSummary {
