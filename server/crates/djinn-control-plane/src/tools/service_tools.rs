...
//! project's selected catalog image declares which presets every task-run Pod
//! provides (see `image_set_services`), and djinn-k8s injects each as a native
//! sidecar with the connection string pre-set in an env var
