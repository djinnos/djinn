...
//
// The `query_subgraph` dispatch/serialisation contract, the parameter-parsing
// tests, and the `WorkspaceFixtureOps` bridge fixture the sibling test modules
// share — one cohesive suite for one module.
//
