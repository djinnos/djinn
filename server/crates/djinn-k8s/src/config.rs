...
pub struct KubernetesConfig {
    ...
    /// private IPC mount, and worker enforcement signal are rendered together.
    /// `disabled` remains an explicit local/development compatibility profile.
...
impl KubernetesConfig {
    ...
    pub fn for_testing() -> Self {
        Self {
            ...
            // Production task-runs are brokered into fresh invocation leaves.
