            ...
            "properties": {
                ...
                "evidence_completion": {
                    ...
                    "properties": {
                        ...
                        "findings": {"type": "array", "items": {"type": "object", "additionalProperties": false, "required": ["check_id", "summary", "anchor"], "properties": {"check_id": {"type": "string"}, "summary": {"type": "string"}, "anchor": {"oneOf": [
                            {"type": "object", "additionalProperties": false, "required": ["kind", "path", "start_line", "end_line", "captured_commit_sha"], "properties": {"kind": {"type": "string", "const": "code"}, "path": {"type": "string"}, "start_line": {"type": "integer", "minimum": 0}, "end_line": {"type": "integer", "minimum": 0}, "captured_commit_sha": {"type": "string"}}},
                            {"type": "object", "additionalProperties": false, "required": ["kind", "node_id", "graph_identity"], "properties": {"kind": {"type": "string", "const": "graph"}, "node_id": {"type": "string"}, "graph_identity": {"type": "string"}}},
        ...
        object!({
            ...
            "properties": {
                ...
                "verification_command": {
                    "type": "string",
                    "description": "Required for a repair reopen. Executable command the next worker must run to verify the fix. When adjudicating a CI failure it must be copied from repository/task context or exposed directly as a command by CI evidence — never invented from a job name. Mutually exclusive with diagnostic_reason."
                },
                "diagnostic_reason": {
                    "type": "string",
                    "enum": ["evidence_incomplete", "provider_action_failed", "no_grounded_remedy", "no_repository_command"],
                    "description": "Required for a diagnostic reopen, which is the correct outcome when you cannot ground a remedy or cannot name a repository-valid verification command. Name what remains unknown in the directive and cite the reason here. Mutually exclusive with verification_command."
                },
                "exclude_models": {
                    "type": "array",
                    "items": {"type": "string"},
