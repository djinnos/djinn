...
pub(crate) use djinn_mcp_extension::tool_defs::{
    tool_schemas_adversary, tool_schemas_advocate, tool_schemas_architect, tool_schemas_evidence_spike,
    tool_schemas_judge, tool_schemas_lead, tool_schemas_planner, tool_schemas_reviewer,
    tool_schemas_worker,
};
