...
impl SupervisorServices for DirectServices {
    ...
    async fn tool_ci_artifact(&self, session_task_id: Option<String>, arguments: serde_json::Map<String, serde_json::Value>) -> Result<serde_json::Value, String> { crate::extension::handlers::call_ci_artifact(&self.callbacks.agent_context, &Some(arguments), session_task_id.as_deref()).await }
