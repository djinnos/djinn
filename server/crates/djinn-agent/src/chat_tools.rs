...
pub fn chat_extension_tool_schemas() -> Vec<serde_json::Value> {
    use crate::extension::tool_defs::{
        tool_code_graph, tool_github_search, tool_lsp, tool_pr_review_context, tool_read,
        tool_shell,
    };
    vec![
        ...
        serde_json::to_value(tool_pr_review_context())
            .expect("serialize tool_pr_review_context"),
