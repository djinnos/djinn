...
/// Bounded synopsis entry point. Returns a deterministic, bullet-formatted
/// synopsis of `text`. Classification: JSON -> binary (None) -> code ->
/// text/log -> None. Never panics. Never exceeds `budget_chars`.
...
mod tests {
    ...
    // -- Existing JSON tests (preserved from ouye) --
    #[test]
