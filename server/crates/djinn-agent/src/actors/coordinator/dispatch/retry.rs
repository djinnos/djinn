...
impl CoordinatorActor {
    ...
    /// fallback.
    pub(in crate::actors::coordinator) fn worktree_has_uncommitted_changes(
    ...
    pub(in crate::actors::coordinator) async fn simple_lifecycle_task_has_durable_artifacts(
        &self,
        task_id: &str,
    ) -> bool {
    ...
    pub(in crate::actors::coordinator::dispatch) async fn resolve_role_model_preference(
        &self,
        project_id: &str,
        base_role: &str,
        created_by_user_id: Option<&str>,
    ...
    pub(in crate::actors::coordinator) async fn dispatch_planner_escalation(
        &mut self,
        source_task_id: &str,
        reason: &str,
        project_id: &str,
