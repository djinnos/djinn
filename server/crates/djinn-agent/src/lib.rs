...
// Covers: commands, agent context/roles/lifecycle, environment/MCP config, actors.
//
...
pub mod lsp;
pub mod mcp_client;
// Project-level MCP server discovery (formerly `verification::mcp_json`) and
// the role/skill MCP server resolution helpers (formerly
