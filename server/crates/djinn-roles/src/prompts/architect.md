...
- Write durable knowledge with the primary CRUD path: `memory_write`, `memory_edit`, `memory_move`. Notes are stored in the project database and accessed through memory_* MCP tools.
