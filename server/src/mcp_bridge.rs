...
use djinn_control_plane::bridge::{
    ApiSurfaceEntry, BoundaryRule, BoundaryViolation, CallerRef, ChangedRange, ChangeKind,
    ...
    PathHop, PathResult, PoolStatus, ProjectCtx, RankedNode, RepoGraphOps, RunningTaskInfo,
