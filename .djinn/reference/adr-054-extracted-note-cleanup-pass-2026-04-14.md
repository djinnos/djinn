...
```json
{
  "before": {
    "heuristic_audit": {
      "archive_candidates_rough": 807,
      "demote_rough": 16,
      "scanned_note_count": 821,
      "underspecified_rough": 818
    },
    "targeted_status": {
  ...
  "projected_after": {
    "heuristic_audit": {
      "archive_candidates_rough": 807,
      "demote_rough": 16,
      "scanned_note_count": 813,
      "underspecified_rough": 810
    },
    "targeted_status": {
...
- The overall ADR-054 backlog remains large (`821` scanned extracted notes), which matches the task goal of making the remaining migration backlog measurable.
...
- The projected `scanned_note_count` drop from `821` to `813` reflects six archive deletions plus two demotions out of the extracted taxonomy.
