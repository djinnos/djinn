---
name: verification
description: Evidence before claims. Use when about to say "done", "fixed", "tests pass", "build succeeds", "works now", "ready to merge", "task complete", before committing, creating PRs, or marking tasks done. Also use when tempted to say "should work", "probably fixed", "looks good". Requires running verification commands and reading output before ANY success claim.
---
